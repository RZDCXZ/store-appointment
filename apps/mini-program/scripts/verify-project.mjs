...
const requiredFiles = [
  ...
  "miniprogram/pages/data-rights/index.json",
  "miniprogram/pages/data-rights/index.ts",
  "miniprogram/pages/data-rights/index.wxml",
  "miniprogram/pages/data-rights/index.wxss",
  ...[
    "booking-pet",
    "booking-service",
    "booking-staff",
