...
COMMENT ON FUNCTION anonymize_store_service_records_for_customer(text) IS
  'Controlled privacy-deletion seam: redacts identity-bearing service text, minimizes outcome events, and drops transient idempotency snapshots while preserving service facts.';
