...
## Product-specific visual decision

- The user selected Product Design visual direction 1 on 2026-08-13.
- Treat `design-reference/mp-01-option-1.png` as the visual source of truth for the mini-program: warm morning-light pet photography, cream canvas, deep sage primary actions, restrained coral accents, and a gentle but professional tone.
- Keep the mini-program under `product-ui/mini-program/`; the future web admin design belongs under `product-ui/admin/`.
