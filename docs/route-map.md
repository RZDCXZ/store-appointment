...
| MP-03     | 宠物列表       | 微信小程序 | `pages/pets/index`                         | `apps/mini-program/miniprogram/pages/pets/`            | 已完成 | 页面登记 + 项目契约测试               |
| MP-04     | 新建宠物       | 微信小程序 | `pages/pet-form/index`                     | `apps/mini-program/miniprogram/pages/pet-form/`        | 已完成 | 页面登记 + 新建路径测试               |
| MP-04     | 编辑宠物       | 微信小程序 | `pages/pet-form/index?id=:petId`           | `apps/mini-program/miniprogram/pages/pet-form/`        | 已完成 | 查询参数恢复 + 重新拉取档案测试       |
| MP-05     | 隐私同意       | 微信小程序 | `pages/privacy-consent/index`              | `apps/mini-program/miniprogram/pages/privacy-consent/` | 已完成 | 页面登记 + 版本门禁 API 测试          |
