...
| MP-01     | 顾客首页       | 微信小程序 | `pages/home/index`                         | `apps/mini-program/miniprogram/pages/home/`           | 已完成 | `app.json` tab 登记 + 项目契约测试   |
| MP-02     | 服务列表       | 微信小程序 | `pages/services/index`                     | `apps/mini-program/miniprogram/pages/services/`       | 已完成 | `app.json` 页面登记 + 项目契约测试   |
| MP-02     | 服务详情       | 微信小程序 | `pages/service-detail/index?id=:serviceId` | `apps/mini-program/miniprogram/pages/service-detail/` | 已完成 | 页面登记 + `onLoad` 查询参数恢复     |
